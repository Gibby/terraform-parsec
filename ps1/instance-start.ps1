...
$ScriptsToRun = @("win16-fix-meta-data.ps1", "set-hostname.ps1", "initialise-disks.ps1", "bind-steam-library.ps1", "extra-apps.ps1", "create-shutdown-file.ps1", "disable-windows-firewall.ps1")
